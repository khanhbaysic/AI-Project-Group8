...
CONFIG = {
    ...
    "video_yaw_threshold": 55.0,
    "video_distraction_duration": 2.0,
    ...
    "video_phone_hold_seconds": 1.5,
    "video_phone_context_seconds": 2.5,
    "video_peer_distraction_enabled": True,
    "video_peer_yaw_threshold": 45.0,
    "video_peer_distraction_duration": 0.75,
    "video_peer_body_only_enabled": True,
    "video_peer_body_distance_ratio": 0.32,
